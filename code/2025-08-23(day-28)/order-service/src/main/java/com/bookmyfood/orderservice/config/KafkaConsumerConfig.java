...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, PaymentEvent> paymentEventConsumerFactory() {
        ...
        configProps.put(JsonDeserializer.TRUSTED_PACKAGES, "com.bookmyfood.orderservice.event");
        configProps.put(JsonDeserializer.TYPE_MAPPINGS, "paymentEvent:com.bookmyfood.orderservice.event.PaymentEvent");
